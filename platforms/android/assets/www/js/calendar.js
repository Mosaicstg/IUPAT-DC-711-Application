...
function addEventSuccess(message) {
	navigator.notification.alert( 'Event added to your calendar.', phoneGapAlert, 'Success', 'OK, Thanks' );
}

function addEventError(message) {
	navigator.notification.alert( 'Event could not be added to your calendar: ' + message, phoneGapAlert, 'Error', 'OK' );
}
